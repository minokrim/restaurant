...
function Fooddetails({loadComponent}){
    ...
    <div className="foodCard">
        <img src={Omelette} alt="" className="foodImage"/>
        <div className="fooddetails">
            <p className="foodTitle">Boiled Yam & Egg</p>
            <div className="foodRating">
            <div className="rating">
    ...
    <div className="cardPair">
    <div className="foodCard">
        <img src={hotbread} alt="" className="foodImage"/>
        <div className="fooddetails">
            <p className="foodTitle">Boiled Yam & Egg</p>
            <div className="foodRating">
            <div className="rating">
    ...
    <div className="foodCard">
        <img src={rice} alt="" className="foodImage"/>
        <div className="fooddetails">
            <p className="foodTitle">Boiled Yam & Egg</p>
            <div className="foodRating">
            <div className="rating">
